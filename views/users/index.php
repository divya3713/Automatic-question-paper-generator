              ...
              <table id="userTable" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php if($user_data): ?>  
                    ...
                    <?php  $i = 0; foreach ($user_data as $k => $v): ?>
                      <tr>
                        <?php  echo '<td>'.++$i.'</td>' ; ?>
                        ...
                        <td>
                          <?php if(in_array('updateUser', $user_permission)): ?>
                            <a href="<?php echo base_url('users/edit/'.$v['user_info']['id']) ?>" class="btn btn-default"><i class="fa fa-edit"></i> Edit</a>
                          <?php endif; ?>
                          <?php if(in_array('deleteUser', $user_permission)): ?>
                            <a href="<?php echo base_url('users/delete/'.$v['user_info']['id']) ?>" class="btn btn-default"><i class="fa fa-trash"></i> Delete</a>
                          <?php endif; ?>
                        </td>
                      <?php endif; ?>
                      </tr>
